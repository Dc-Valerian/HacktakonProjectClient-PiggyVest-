...
const Todo = () => {
  return (
    <Container>
        <Left>
            <Top><p>TO-DO LIST</p></Top>
            <Box>
                <Checkbox></Checkbox>
                <Text><p>Verify your email address</p></Text>
            </Box>
            <Box>
                <Checkbox></Checkbox>
                <Text><p>Add your BVN or NIN now!</p></Text>
            </Box>
            <Box>
                <Checkbox></Checkbox>
                <Text><p>Tell us more abiut yourself</p></Text>
            </Box>
            <Box>
                <Checkbox></Checkbox>
                <Text><p>Securely add a valid debit card</p></Text>
            </Box>
            <Box>
                <Checkbox></Checkbox>
                <Text><p>Set your security question now! 🔐 🔐</p></Text>
            </Box>
            <Box>
                <Checkbox></Checkbox>
                <Text><p>Refer a friend, earn ₦1,000.00 bonus 🎉</p></Text>
            </Box>
            <Card>
                <Icon><FiThumbsUp /></Icon>
                <Texthold>
                    <p><span>See your recent activities</span></p>
            ...
            <Card2>
                <Icon2><FiLock /></Icon2>
                <Texthold2>
                    <p><span>Create a Safelock</span></p>
                    <p>Avoid spending temptations. Tap to create a safelock</p>
                </Texthold2>
            </Card2>
            <Card3>
                <Icon3><FiThumbsUp /></Icon3>
                <Texthold3>
                    <p><span>Link ypur Pocket App</span></p>
                    <p>Withdraw from your PiggyVest safer & faster 💜</p>
                </Texthold3>
            </Card3>
            <Recent><p>RECENT ACTIVITIES</p></Recent>
            <Card4>
                <Img src={img} />
                <Texthold4>
                    <p><span>Just registered</span></p>
                    <p>2 mins ago</p>
                </Texthold4>
            </Card4>
