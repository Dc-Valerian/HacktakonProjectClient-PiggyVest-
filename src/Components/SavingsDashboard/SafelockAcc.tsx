  ...
  return (
    <Container>
        <Left>
            <Top>
                <Up>
                    <Text><p>SAFELOCK BALANCE</p></Text>
                    <Naira>
                    <h3>₦0.00</h3>
                </Naira>
                </Up>
                <Down>
                    <Box>
                        ...
                        <Write><p>Create a Safelock</p></Write>
                    </Box>
                    <Box>
                        <Icons><BiHash /></Icons>
                        <Write><p>What is a Safelock?</p></Write>
                    </Box>
                </Down>
            </Top>
            <Below>
                <Up>
                    <Text><p>MY SAFELOCKS</p></Text>
                    <Naira2>
                    <All1>Ongoing</All1>
                    <All2>Completed</All2>
                </Naira2>
                ...
                <Trans>
                    ...
                    <No><p>You have no SafeLock setup. Let's help you get started.</p></No>
