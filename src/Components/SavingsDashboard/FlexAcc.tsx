  ...
  return (
    <Container>
        <Left>
            <Top>
                <Up>
                    <Text><p>FLEX ACCOUNT (8%)</p></Text>
                    <Naira>
                    <h3>₦0.00</h3>
                </Naira>
                <Avai>
                    <h4>Available Balance: <span>₦0.00</span></h4>
                </Avai>
                </Up>
                <Down>
                    <Box>
                        <Icons><BsBookmarkFill /></Icons>
                        <Write><p>New Label</p></Write>
                    </Box>
                    <Box>
             ...
             <Int>
                <Text><p>Introducing: Labels 🎉</p></Text>
                <Prc><p>Labels lets you organise your emergency funds based on your needs.</p></Prc>
                <Betton><h4>LEARN MORE</h4></Betton>
            </Int>
            <Below>
                <Up>
        ...
        <Right>
            <But><h3>GET ACCOUNT NUMBER</h3></But>
        </Right>
    </Container>
  )
}
