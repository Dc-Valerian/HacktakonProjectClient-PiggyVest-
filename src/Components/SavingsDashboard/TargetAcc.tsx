...
import {AiOutlinePercentage, AiFillBank, AiFillSetting, AiOutlinePlus} from "react-icons/ai"
    ...
    <Container>
        <Left>
            <Top>
                ...
                <Down>
                    <Box>
                        <Icons><AiOutlinePlus /></Icons>
                        <Write><p>Create a Target</p></Write>
                    </Box>
                    <Box>
                        <Icons><BiHash /></Icons>
                        <Write><p>Learn More</p></Write>
                    </Box>
                </Down>
            </Top>
            <Below>
                <Up>
                    <Text><p>MY SAFELOCKS</p> <span>Explore Targets</span></Text>
                    <Naira2>
                    <All1>Ongoing</All1>
                    <All2>Completed</All2>
                </Naira2>
                ...
                <Trans>
                    ...
                    <No><p>Save with discipline towards a specific goal or target. Earn interests every day into your Flex wallet. Let's help you get started.</p></No>
